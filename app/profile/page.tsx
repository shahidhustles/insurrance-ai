  ...
  useEffect(() => {
    if (userRole !== undefined) {
      if (userRole) {
        ...
        router.push(`/dashboard/${userRole}/${user?.id}`);
      } else {
        // Only set loading to false if user doesn't have a role
        setIsLoading(false);
      }
    }
  ...
  return (
    <div className="container mx-auto py-10 min-h-screen flex flex-col items-center">
      {isLoading ? (
        ...
        // Only render the form content when isLoading is false
        <>
          <motion.div
            ...
            >
              ...
              {role === "insurer" && (
                <Card className="shadow-lg">
                  ...
                  <CardFooter onClick={handleSubmit}>
